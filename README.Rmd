...
identifiers from a database of choice) and `interactionID` (identifier of a
chromatin loop). As some loop anchors overlapped multiple Transcription Start
Sites, possibly of many genes, for these loops the dataset contains all
combinations.
...
shown; you can change this by setting `minCount` to any other value.
